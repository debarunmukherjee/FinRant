            ...
            <Listbox value={selected} onChange={setSelected}>
                <div className="relative mt-1">
                    <Listbox.Button
                        ...
                        <span className="block truncate">{selected ? selected[label] : noOptionText}</span>
                        ...
                        <Listbox.Options
                            ...
                            {options.map((option, optIdx) => (
                                <Listbox.Option
                                    key={optIdx}
                                    className={
                                        ({active}) => `${active ? 'text-amber-900 bg-amber-100' : 'text-gray-900'} hover:bg-blue-100 cursor-default select-none relative py-2 pl-10 pr-4`
                                    }
                                    value={option}
                                >
                                    {({selected, active}) => (
